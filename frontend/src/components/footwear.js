...
export default function FoowearProduct() {
    ...
    <Box sx={{ bgcolor: '#fff', minHeight: '100vh', py: 2 }}>
        ...
        <Container maxWidth="xl">
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 2 }}>
            ...
            <Box sx={{ display: 'flex', alignItems: 'baseline', gap: 0.5, flexGrow: 1, justifyContent: { xs: 'flex-start', sm: 'center' } }}>
              <Typography variant="h6" sx={{ fontWeight: 700, color: '#282c3f' }}>Footwear</Typography>
      ...
      <Container maxWidth="xl" sx={{ mb: 3 }}>
        <Breadcrumbs separator=">" aria-label="breadcrumb" sx={{ fontSize: '12px' }}>
          ...
          <Typography color="text.primary" sx={{ fontSize: '12px', fontWeight: 600 }}>Footwear</Typography>
        </Breadcrumbs>
      </Container>
